...
if __name__ == "__main__":
    ...
    mdFile.new_paragraph('⚠️Automatically generated page. Any changes will be overwritten. ⚠')
    mdFile.new_line()
    mdFile.create_marker('toc')
    ...
    mdFile.new_paragraph('⚠️Automatically generated page. Any changes will be overwritten. ⚠')
    mdFile.new_table_of_contents(table_title='Contents', depth=2, marker='toc')
